...
mvn_cmd = "mvn urts:urts -Dtest=\!FileSystemFactoryTest -DgetterClass=TestGetConfigValueForConfigAware -Dcheckstyle.skip -Dlicense.skip -Dfindbugs.skip -Dmaven.javadoc.skip=true -DfailIfNoTests=false -Dmaven.test.failure.ignore=true | tee out.txt"
