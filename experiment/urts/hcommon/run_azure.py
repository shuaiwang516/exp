...
mvn_cmd = "mvn urts:urts -DgetterClass=TestGetConfigValueForConfigAware -DfailIfNoTests=false"
...
# TODO: The current record number is not useful.
...
#     print("{}TEST_CLASS_NUM: {}-{} : {}\n".format(DEBUG_PREFIX, curConfig, curCommit, int(p.read())), flush=True)
